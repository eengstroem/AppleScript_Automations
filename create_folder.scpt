tell application "Finder"
	...
	repeat with this_file in mlist
		...
		set new_name to text 9 thru (strLength + (offset of "J" in text) - (length of cur_ext) + 2) of (name of this_file as text)
		set new_folder to make new folder with properties {name:new_name} at current_folder --asiojxoja-axiajo aois jxoai
